        ...
        <li className={styles.Icon}>
          <a href={props.href} className={styles.IconLink}>
            <svg xmlns='http://www.w3.org/2000/svg' width='9' height='18' viewBox='0 0 9 18'>
              <path className={styles.IconLinkPath} id='facebook' class='cls-1' d='M698,174h-3v-9h-3.009L692,162h3v-2c0-2.535.769-4.015,3.618-4.015h2.37L701,159h-2c-1.109,0-1,.19-1,1v2h3l-0.307,3H698v9Z' transform='translate(-692 -156)' />
            </svg>
          </a>
        </li>
      )
        ...
        <li className={styles.Icon}>
          <a href={props.href} className={styles.IconLink}>
            <svg xmlns='http://www.w3.org/2000/svg' width='21' height='21' viewBox='0 0 21 21'>
              <path className={styles.IconLinkPath} id='instagram' class='cls-1' d='M766,154h9a6,6,0,0,1,6,6v9a6,6,0,0,1-6,6h-9a6,6,0,0,1-6-6v-9A6,6,0,0,1,766,154Zm0,2h9a4,4,0,0,1,4,4v9a4,4,0,0,1-4,4h-9a4,4,0,0,1-4-4v-9A4,4,0,0,1,766,156Zm4.5,3a5.5,5.5,0,1,1-5.5,5.5A5.7,5.7,0,0,1,770.5,159Zm0.081,2A3.423,3.423,0,0,1,774,164.419a3.67,3.67,0,0,1-3.566,3.566,3.422,3.422,0,0,1-3.421-3.423A3.67,3.67,0,0,1,770.581,161ZM776,158a1,1,0,1,1-1,1A1,1,0,0,1,776,158Z' transform='translate(-760 -154)' />
            </svg>
          </a>
        </li>
      )
